package aalessons.day17arrayllist01;
...
public class ArrayList01 {
    ...
    */
    ...
    public static void main(String[] args) {
       ...
       //Bir listeki tum elemanlari nasil silebilirim?//Clear methodu"clear"


        //ages.clear();
        System.out.println(ages);//[]
      //Bir elemanin Listte var olup olmadgini nasil kontrol ederizz?Contains ile yaparoz
      ...
      boolean r=  ages.contains(656);
        ...
        //Example1:Verilen iki Integer listte tamamiyla ayni elemanlarin olup olmadigini kontrol eden kodu yaziniz.
        ...
        boolean t= nums1.equals(nums2);//True
